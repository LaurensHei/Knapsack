...
public class UI extends JPanel
{
    ...
    {
        if(i==0) {return Color.BLUE;} //X
        else if(i==1) {return Color.ORANGE;} //I
        else if(i==2) {return Color.CYAN;} // Z
        else if(i==3) {return Color.GREEN;} //T
        else if(i==4) {return Color.MAGENTA;} //U
        else if(i==5) {return Color.PINK;} //V
        else if(i==6) {return Color.RED;} //W
        else if(i==7) {return Color.YELLOW;} //Y
        else if(i==8) {return new Color(0, 0, 0);} //L
        else if(i==9) {return new Color(0, 0, 100);} //P
        else if(i==10) {return new Color(100, 0,0);} //N
        else if(i==11) {return new Color(0, 100, 0);} //F
