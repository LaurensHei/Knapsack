...
public class ParcelList {
    ...
    //parcel A initialization, there are no mutation for this block
    public static int[][][][] parcelBuilder = {

    // parcel A representation 
   ...
   // A second mutation
   {
    ...
    public static int [][][][] pentominoBuilder = {
        {   // T Pentomino
            {{1,1,1}},
            {{0,1,0}},
            {{0,1,0}}
    ...
    public static ArrayList<int[][][]> data3 = new ArrayList<>();
